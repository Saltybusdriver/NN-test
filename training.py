...
if __name__ == "__main__":
    ...
    parser.add_argument('--mnist_path', type=str, default="/home/metarou/Code/CPP-NNlib/Dataset/", help='Path containing MNIST-JPG folders')
    parser.add_argument('--cifar_path', type=str, default="/home/metarou/Code/CPP-NNlib/Dataset/CIFAR-10/", help='Path for CIFAR-10 data (will download if needed)')
    parser.add_argument('--boston_csv', type=str, default="/home/metarou/Code/CPP-NNlib/Dataset/Boston.csv", help='Path to Boston housing CSV')
    parser.add_argument('--california_csv', type=str, default="/home/metarou/Code/CPP-NNlib/Dataset/housing.csv", help='Path to California housing CSV')
    parser.add_argument('--ae_image_path', type=str, default="/home/metarou/Code/CPP-NNlib/Dataset", help='Path to images for Autoencoder training')
    ...
    try:
        train_cifar_classifier(
            ...
            image_height=64, image_width=64, # Standard CIFAR size
